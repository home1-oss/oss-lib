 ...
 */
public class RestTemplateForTest15x implements RestTemplateForTest {

  private final TestRestTemplate restTemplate;

  public RestTemplateForTest15x(final RestTemplateBuilder restTemplateBuilder) {
    this.restTemplate = new TestRestTemplate(restTemplateBuilder);
  }

  public RestTemplateForTest15x(final TestRestTemplate.HttpClientOption... httpClientOptions) {
    this.restTemplate = new TestRestTemplate(httpClientOptions);
  }

  public RestTemplateForTest15x( //
  ...
  public RestTemplateForTest15x(final RestTemplate restTemplate) {
  ...
  public RestTemplateForTest15x(final TestRestTemplate restTemplate) {
  ...
  public RestTemplateForTest withBasicAuth(final String username, final String password) {
    return new RestTemplateForTest15x(this.restTemplate.withBasicAuth(username, password));
  }
